...
(function(window, $, undefined) {
	...
	$.infinitescroll.defaults = {
		...
		path : undefined,
		scrollNearBottomCallback : undefined
	};
	$.infinitescroll.prototype = {
		...
		scroll : function infscr_scroll() {
			if (this._nearbottom())
			{
				var nearBottomCallBackHandler = this.options.scrollNearBottomCallback;
				if(nearBottomCallBackHandler !== undefined) this.options.scrollNearBottomCallback();
				return;
			}
